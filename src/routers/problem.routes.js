...
router.route('/delete/:problemId').delete(varifyJWt,contestAuth,problemAuth,deleteProblem)  // pending
router.route('/add/l/:problemId').patch(varifyJWt,contestAuth,problemAuth,addLanguagesToProblem) // Language model need to prepare 
...
router.route('/get').get(getContestProblems)
